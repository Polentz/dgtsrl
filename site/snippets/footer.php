<address id="contatti" class="address --dark-theme">
    <div class="address-wrapper">
        <ul class="contact-list">
            <li class="contact-item --text-title">
            ...
            <li class="contact-item --text-title">
                ...
                <p><a href="mailto:dgtsrl@gmail.com">dgtsrl@gmail.com</a></p>
            </li>
            <li class="contact-item --text-title">
                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="false" viewBox="0 0 34 34" aria-label="LinkedIn"
                    role="img">
                    <path
                ...
                <p><a href="https://www.linkedin.com/company/dgt-srl-il-mondo-intorno-alla-tua-finestra"
                        target="_blank">LinkedIn</a></p>
            </li>
        </ul>
        <p class="contact-item --text-title" style="text-align: end;">Via dell'Industria, 58 <br>
            60020 Polverigi (AN)</p>
    </div>
</address>

<footer class="colophon --dark-theme">
    <div class="colophon-wrapper">
        <div class="colophon-block --text-caption">
            <p>©
                <?= date("Y") ?>
                <?= $site->title() ?>
            </p>
            <p>P.IVA: IT01338350422</p>
        </div>
        <div class="colophon-block --text-caption">
            <p>Website <a href="https://www.iampolenta.com/" target="_blank">Giulia Polenta</a></p>
        </div>
    </div>
</footer>