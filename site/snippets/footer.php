<section id="contatti" class="section section--block">
    <div class="container">
...
<footer class="footer">
        ...
        <div class="container">
            <div class="contact">
                <ul class="contact-list">
                    <li class="footer-item --text-body">
                    ...
                    <li class="footer-item --text-body">
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="false" viewBox="0 0 34 34"
                ...
                <div class="footer-item --text-body">
                    <p>Via dell'Industria, 58 <br>
    ...
    <div class="footer-section">
        <div class="container">
            <div class="footer-item --text-caption">
                <p>©
                    <?= date("Y") ?>
                    <?= $site->title() ?>
                </p>
